...
{
    /**
     * @var string the locale ID (e.g. 'fr', 'de', 'en-GB', 'zh-TW', 'zh-CN') for the language to be used by the date picker.
    ...
    public function init()
    {
        ...
        if (isset($this->options['changeMonth'])) {
            $this->changeMonth = $this->options['changeMonth'];
        }
        if (isset($this->options['changeYear'])) {
            $this->changeYear = $this->options['changeYear'];
        }
    }
    ...
    public function run()
    {
        ...
        $this->clientOptions['changeMonth'] = $this->changeMonth;
        $this->clientOptions['changeYear']  = $this->changeYear;
